...
export const mcpToolDefinitions: ChatCompletionTool[] = [
  ...
  // ====================================================
  {
    ...
    function: {
      ...
      description: '최신 뉴스 헤드라인을 조회합니다. 카테고리별로 필터링할 수 있습니다.',
      parameters: {
        type: 'object',
        properties: {
          category: {
            ...
            description: '뉴스 카테고리 (선택사항)'
          },
          pageSize: {
            type: 'number',
            description: '가져올 뉴스 수 (기본: 10)'
          }
        },
        required: []
      }
      ...
      parameters: {
        ...
        properties: {
          ...
          sortBy: {
            ...
            description: '정렬 방식 (기본: publishedAt)'
          },
          pageSize: {
            type: 'number',
            description: '가져올 뉴스 수 (기본: 10)'
  ...
  },
  {
    type: 'function',
    function: {
      name: 'news_get_briefing',
      description: '뉴스 브리핑을 생성합니다. 어젯밤/오늘 뉴스를 요약해서 보여줍니다.',
      parameters: {
        type: 'object',
        properties: {
          type: {
            type: 'string',
            enum: ['overnight', 'today'],
            description: '브리핑 유형: overnight(어젯밤), today(오늘)'
          }
        },
        required: ['type']
      }
